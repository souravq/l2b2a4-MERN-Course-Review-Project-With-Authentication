    ...
    try {
        ...
        const newCourseDataArr = resultData === null || resultData === void 0 ? void 0 : resultData.result.map((courseData) => {
            return {
                ...
                createdBy: {
                    _id: courseData.createdBy ? courseData.createdBy._id : null,
                    username: courseData.createdBy ? courseData.createdBy.username : null,
                    email: courseData.createdBy ? courseData.createdBy.email : null,
                    role: courseData.createdBy ? courseData.createdBy.role : null,
                },
